...
const Progressbar = ({ progress }: { progress: any }) => {
  return (
    <div className="px-4 bg-gray-800">
      ...
      <div className="after:mt-4 after:block after:h-1 after:w-full after:rounded-lg after:bg-gray-300">
        <ol className="grid grid-cols-3 text-sm font-medium text-gray-600">
          <li
            className={`relative flex justify-start ${
              progress > 0 ? "text-gray-100" : ""
            }`}
          >
            <span
            ...
            <span className="hidden sm:block"> Scrapping </span>
          ...
          <li
            className={`relative flex justify-end ${
              progress > 2 ? "text-gray-100" : ""
            }`}
          >
            <span
              className={`absolute -bottom-[1.75rem] end-0 rounded-full ${
                progress > 2 ? "bg-blue-600" : "bg-gray-300"
              } text-white`}
            >
              <svg
                className="h-5 w-5"
